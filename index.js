...
function Database($config, $injector, $configPath) {
    this.$config = $config;
...
Database.$inject = ["$config", "$injector", "$configPath"];
...
Database.prototype.getModels = function * (modelsDir) {
    var appDir = this.$configPath.appDir,
